...
const highlights = [
  {
    text: 'Close to Cyber City & Golf Course Extension Road Business Hubs',
    icon: <BookOpen {...highlightIconProps} />,
  },
  {
    text: '1.5 Lakh Sq.Ft. Private Clubhouse',
    icon: <Trophy {...highlightIconProps} />,
  },
  {
    text: 'Infinity Pool with Temperature Control & Cabanas',
    icon: <Waves {...highlightIconProps} />,
  },
  {
    text: 'Spa with Steam, Sauna & Wellness Therapy Rooms',
    icon: <HeartPulse {...highlightIconProps} />,
  },
  {
    text: 'Private Theatre with Dolby Atmos Sound System',
    icon: <Laptop {...highlightIconProps} />,
  },
  {
    text: 'State-of-the-art Fitness Center',
    icon: <Dumbbell {...highlightIconProps} />,
  },
  {
    text: 'Luxury Spa & Wellness Zone (Steam & Sauna)',
    icon: <HeartPulse {...highlightIconProps} />,
  },
  {
    text: 'Located just 2 Minutes from NH-48 (Delhi–Jaipur Highway)',
