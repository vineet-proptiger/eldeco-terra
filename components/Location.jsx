...
const locationItems = [
  'Located just 2 minutes from NH-48 (Delhi–Jaipur Highway)',
  '5 minutes from Southern Peripheral Road (SPR)',
  '15 minutes from Dwarka Expressway',
  '25 minutes drive to IGI Airport',
  '5 minutes from HUDA City Centre Metro Station',
  'Within 5 km of DPS, Shiv Nadar & Heritage Xperiential School',
]
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-stretch">
          ...
          <div className="w-full lg:flex-1" data-aos="fade-left" style={{ minHeight: '420px' }}>
            <div style={{
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3510.8206158864223!2d76.95016467549105!3d28.36427247581227!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d3d8f210b4b1d%3A0x1599d87b9864d264!2sEldeco%20Terra%20%26%20Sol!5e0!3m2!1sen!2sin!4v1777456444738!5m2!1sen!2sin"
                width="100%"
                height="100%"
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  Sector 80, Gurugram, Haryana 122004
                </span>
              </div>
            </div>
          </div>
