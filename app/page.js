    ...
    <main className="relative min-h-screen bg-white">
      ...
      <div className="sticky-bottom-bar">
        <a
          ...
          className="flex-1 flex flex-col items-center justify-center gap-1 !py-1 !px-0 transition-all bg-white"
          style={{ borderTop: '1px solid #f3f4f6' }}
        >
          <div className="flex items-center justify-center rounded-full" style={{ width: '26px', height: '26px', border: '2px solid #0ea5e9', color: '#0ea5e9' }}>
          ...
          <span style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.04em', color: '#0ea5e9', fontFamily: 'var(--font-jost)' }}>Call Us</span>
        </a>
        <button
          onClick={() => setIsOpen(true)}
